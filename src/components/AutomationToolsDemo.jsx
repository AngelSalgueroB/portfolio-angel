...
const TOOLS = [
  {
    ...
    color: "#16a34a",
    desc: "Unificar múltiples reportes .xlsx",
  },
  {
    id: "folders",
    name: "Folder Gen",
    ...
    color: "#3b82f6",
    desc: "Creación masiva de directorios",
  },
  {
    id: "eraser",
    name: "Img Eraser",
    ...
    color: "#ef4444",
    desc: "Recorte automático de imágenes",
  },
  {
    id: "packing",
    name: "Packing List",
    icon: <Layers size={18} />,
    color: "#f59e0b",
    desc: "Generador de Layouts y PL",
  },
];
          ...
          {status === "idle" && (
            ...
            >
              ...
              <p style={{ fontSize: "0.9rem" }}>
                Listo para iniciar. Haz clic en "Ejecutar".
              </p>
            </div>
          )}
